<div class="relative pt-[60px] lg:pt-[80px] pb-[110px] bg-white dark:bg-slate-800">
  <div class="container">
    <div class="flex flex-wrap -mx-4">
        <img
                src="https://media.licdn.com/dms/image/C4D03AQFfcqBYm10Zvg/profile-displayphoto-shrink_800_800/0/1667993046090?e=1682553600&v=beta&t=j1d1eCln74v3VN0JNn0ffeR9HObguIUESzVUyBEtbew"
                alt="hero"
                class="max-w-[500px] max-h-[500px] lg:mr-auto rounded-lg"
