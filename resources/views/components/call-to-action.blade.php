...
<section class="py-20 lg:py-[120px] dark:bg-slate-700">
    <div class="container mx-auto">
      <div
        class="bg-primary relative z-10 overflow-hidden rounded py-12 px-8 md:p-[70px]"
      >
        <div class="-mx-4 flex flex-wrap items-center">
          <div class="w-full px-4 lg:w-1/2">
            <span class="mb-2 text-base font-semibold text-white">
              Check out my Devlog or
            </span>
            <h2
              class="mb-6 text-3xl font-bold leading-tight text-white sm:mb-8 sm:text-[38px] lg:mb-0"
            >
              Play my games on<br class="xs:block hidden" />
              itch.io for FREE
            </h2>
          </div>
          <div class="w-full px-4 lg:w-1/2">
            <div class="flex flex-wrap lg:justify-end">
              <a
                href="https://justice-bole.itch.io/dodger/devlog/460605/audio-troubles-in-your-raylib-web-build-try-these-solutions"
